document.getElementById('showCartButton').addEventListener('click', function () {
    ...
    displayCartItems();
    cartMenu.style.right = cartMenu.style.right === '0px' ? '-600px' : '0';
    cartMenu.style.boxShadow = cartMenu.style.right === '0px' ? '0 0 15px rgba(0, 0, 0, 0.7)' : 'none'; // Added box-shadow effect
});

document.getElementById('closeCartButton').addEventListener('click', function () {
    let cartMenu = document.getElementById('cartMenu');
    cartMenu.style.right = '-600px';
    cartMenu.style.boxShadow = 'none'; // Removed box-shadow effect
});
